...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        //hien tai(this) vs qua khu (previous)
    ...
    checkValidateInput = () => {
        ...
        let isValidEmail = emailRegex.test(this.state.email);
        ...
        let phoneNumberRegex = /^(?:\+?84|0)(?:\d){9,10}$/;
        let isValidPhone = phoneNumberRegex.test(this.state.phoneNumber);
